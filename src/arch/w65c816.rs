...
fn op_stack(p: &memory::Pointer<Pointer>, bus: &Bus) -> Vec<Operand> {
    match bus.read_unit(p).into_concrete() {
        Some(litval) => vec![op::indir(op::wrap(
            "",
            vec![op::dptr(p.contextualize(u24::from(litval))), op::sym("S")],
            "",
        ))],
...
fn op_zpage_dblptr(p: &memory::Pointer<Pointer>, bus: &Bus) -> Vec<Operand> {
    match bus.read_unit(p).into_concrete() {
        ...
        None => vec![op::indir(op::wrap(
            "(",
            vec![op::indir(op::wrap("", vec![op::miss()], ""))],
            ")",
        ))],
    }
}
...
fn op_zpage_dblptr_index_x(p: &memory::Pointer<Pointer>, bus: &Bus) -> Vec<Operand> {
    match bus.read_unit(p).into_concrete() {
        ...
        None => vec![op::indir(op::wrap(
            "(",
            vec![op::indir(op::wrap("", vec![op::miss(), op::sym("X")], ""))],
            ")",
        ))],
    }
}
...
fn op_zpage_dblptr_index_y(p: &memory::Pointer<Pointer>, bus: &Bus) -> Vec<Operand> {
    match bus.read_unit(p).into_concrete() {
        ...
        None => vec![op::indir(op::wrap(
            "(",
            vec![op::indir(op::wrap("", vec![op::miss()], "")), op::sym("Y")],
            ")",
        ))],
    }
}
...
fn op_stack_dblptr_index_y(p: &memory::Pointer<Pointer>, bus: &Bus) -> Vec<Operand> {
    match bus.read_unit(p).into_concrete() {
        ...
        None => vec![
            op::indir(op::wrap(
                "(",
                vec![op::indir(op::wrap("", vec![op::miss(), op::sym("S")], ""))],
                ")",
            )),
            op::sym("Y"),
        ],
...
pub fn disassemble(
    ...
    match mem.read_unit(p).as_concrete() {
        ...
        Some(0xA0) => (
            Some(inst::new(
                "LDY",
                op_lit(&(p.clone() + u24::from(1 as u8)), mem),
            )),
            u24::from(2 as u8),
            true,
            true,
        ...
        Some(0xA1) => (
            Some(inst::new(
                "LDA",
                op_zpage_dblptr_index_x(&(p.clone() + u24::from(1 as u8)), mem),
            )),
            u24::from(2 as u8),
            true,
            true,
        ...
        Some(0xA3) => (
            Some(inst::new(
                "LDA",
                op_stack(&(p.clone() + u24::from(1 as u8)), mem),
            )),
            u24::from(2 as u8),
            true,
            true,
        ...
        Some(0xA4) => (
            Some(inst::new(
                "LDY",
                op_zpage_ptr(&(p.clone() + u24::from(1 as u8)), mem),
            )),
            u24::from(2 as u8),
            true,
            true,
        ...
        Some(0xA7) => (
            Some(inst::new(
                "LDA",
                op_zpage_dblfarptr(&(p.clone() + u24::from(1 as u8)), mem),
            )),
            u24::from(2 as u8),
            true,
            true,
        ...
        Some(0xAC) => (
            Some(inst::new(
                "LDY",
                op_ptr(&(p.clone() + u24::from(1 as u8)), mem),
            )),
            u24::from(3 as u8),
            true,
            true,
        ...
        Some(0xAF) => (
            Some(inst::new(
                "LDA",
                op_fullptr(&(p.clone() + u24::from(1 as u8)), mem),
            )),
            u24::from(4 as u8),
            true,
            true,
        ...
        Some(0xB1) => (
            Some(inst::new(
                "LDA",
                op_zpage_dblptr_index_y(&(p.clone() + u24::from(1 as u8)), mem),
            )),
            u24::from(2 as u8),
            true,
            true,
        ...
        Some(0xB2) => (
            Some(inst::new(
                "LDA",
                op_zpage_dblptr(&(p.clone() + u24::from(1 as u8)), mem),
            )),
            u24::from(2 as u8),
            true,
            true,
        ...
        Some(0xB3) => (
            Some(inst::new(
                "LDA",
                op_stack_dblptr_index_y(&(p.clone() + u24::from(1 as u8)), mem),
            )),
            u24::from(2 as u8),
            true,
            true,
        ...
        Some(0xB4) => (
            Some(inst::new(
                "LDY",
                op_zpage_index_x(&(p.clone() + u24::from(1 as u8)), mem),
            )),
            u24::from(2 as u8),
            true,
            true,
        ...
        Some(0xB6) => (
            Some(inst::new(
                "LDX",
                op_zpage_index_y(&(p.clone() + u24::from(1 as u8)), mem),
            )),
            u24::from(2 as u8),
            true,
            true,
        ...
        Some(0xB7) => (
            Some(inst::new(
                "LDA",
                op_zpage_dblfarptr_index_y(&(p.clone() + u24::from(1 as u8)), mem),
            )),
            u24::from(2 as u8),
            true,
            true,
        ...
        Some(0xB9) => (
            Some(inst::new(
                "LDA",
                op_ptr_index_y(&(p.clone() + u24::from(1 as u8)), mem),
            )),
            u24::from(3 as u8),
            true,
            true,
        ...
        Some(0xBC) => (
            Some(inst::new(
                "LDY",
                op_ptr_index_x(&(p.clone() + u24::from(1 as u8)), mem),
            )),
            u24::from(3 as u8),
            true,
            true,
        ...
        Some(0xBF) => (
            Some(inst::new(
                "LDA",
                op_fullptr_index_x(&(p.clone() + u24::from(1 as u8)), mem),
            )),
            u24::from(4 as u8),
            true,
            true,
