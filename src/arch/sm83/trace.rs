...
fn read_value_from_targetreg<IO>(
...
fn write_value_to_targetreg<IO>(
    p: &memory::Pointer<PtrVal>,
    mem: &Bus<IO>,
    state: &mut State,
    trace: &mut Trace,
