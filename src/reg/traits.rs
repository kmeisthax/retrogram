...
/// convenience.
pub trait Bitwise: Clone + Zero + BoundWidth<usize> + Shl<usize, Output=Self> + BitAnd<Output=Self> +
    BitXor<Output=Self> + BitOr<Output=Self> + Not<Output=Self> {

}

impl<T> Bitwise for T where T: Clone + Zero + BoundWidth<usize> + Shl<usize, Output=Self> + BitAnd<Output=Self> +
    BitXor<Output=Self> + BitOr<Output=Self> + Not<Output=Self> {
